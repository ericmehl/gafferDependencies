{
	...
	"platform:windows" : {
		...
		"commands" : [
			...
			"move {buildDir}\\lib\\python{pythonVersion}\\site-packages\\pyopenvdb.pyd {buildDir}\\python\\pyopenvdb.pyd",
			"move {buildDir}\\lib\\python{pythonVersion}\\site-packages\\pyopenvdb*.lib {buildDir}\\lib\\"
		],
